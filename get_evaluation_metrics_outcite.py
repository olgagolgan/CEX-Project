...
input_data = ['grobid_xmlOUT']
text_file = input_data[0]

path_to_gs = '/Users/olga/Desktop/boh'
path_to_output = '/Users/olga/Desktop/'
...
def get_file_data(path, parser_name):
    ...
    files_list.sort()
    print("i am out: ", len(files_list))
    print("i am gs: ", len(list(os.listdir(path_to_gs))))
